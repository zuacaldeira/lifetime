 ...
 * @author zua
 */
public class TimelineView extends UserView {

    public TimelineView(String username, String language) {
    ...
    protected LifetimeContent createContent() {
        return new TimelineContent(getUsername(), getLanguage());
    }

    @Override
    protected LifetimeMenu createMenu() {
        return new TimelineMenu(getUsername(), getLanguage());
    }
