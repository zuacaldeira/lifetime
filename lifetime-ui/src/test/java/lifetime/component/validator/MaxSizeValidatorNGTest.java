...
import lifetime.component.validator.MaxSizeValidator;
 ...
 * @author zua
 */
public class MaxSizeValidatorNGTest {

    public MaxSizeValidatorNGTest() {
    }
    ...
    public void testValidate(String value) {
        ...
        MaxSizeValidator instance = new MaxSizeValidator();
