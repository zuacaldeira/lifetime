...
import old.ui.form.SocialFormTranslate;
import old.ui.form.SocialFormEdit;
 ...
 * @author lifetime
 */
public class SocialQAView extends QAView<Social> {

    public SocialQAView(Social item) {
    ...
    protected void showEditForm() {
        SocialFormEdit afe = new SocialFormEdit(getItem(), getList());
    ...
    protected void showTranslateTo(String language) {
        SocialFormTranslate aftt = new SocialFormTranslate(getItem(), language, getList());
