...
import old.ui.form.OtherFormEdit;
import old.ui.form.OtherFormTranslate;
 ...
 * @author lifetime
 */
public class OtherQAView extends QAView<Other> {

    public OtherQAView(Other item) {
    ...
    protected void showEditForm() {
        OtherFormEdit afe = new OtherFormEdit(getItem(), getList());
    ...
    protected void showTranslateTo(String language) {
        OtherFormTranslate aftt = new OtherFormTranslate(getItem(), language, getList());
