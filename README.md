...
- lifetime-web-vaadin-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- lifetime-web-vaadin-ui: main application module, development time
- lifetime-web-vaadin-production: module that produces a production mode WAR for deployment
