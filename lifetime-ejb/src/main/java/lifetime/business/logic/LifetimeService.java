...
import lifetime.business.persistence.Comment;
import lifetime.business.persistence.Country;
...
import lifetime.business.persistence.UserRoles;
import lifetime.business.persistence.UserTodo;
import lifetime.business.persistence.Visits;
import lifetime.business.persistence.WelcomeMessage;
import lifetime.business.persistence.Word;
...
//        }
    ...
    public void sendJobApplication(Integer userId, String language, JobApplication jobApplication, byte[][] documents) {
        ...
        System.out.println("User: " + getUser(userId).getEmail());
