...
public class Keys {
    ...
    public static final Identity<KnowledgeUnitRecord, Integer> IDENTITY_KNOWLEDGE_UNIT = Identities0.IDENTITY_KNOWLEDGE_UNIT;
    public static final Identity<KnowHowUnitRecord, Integer> IDENTITY_KNOW_HOW_UNIT = Identities0.IDENTITY_KNOW_HOW_UNIT;
    ...
    public static final Identity<WorkUnitRecord, Integer> IDENTITY_WORK_UNIT = Identities0.IDENTITY_WORK_UNIT;
    ...
    public static final UniqueKey<KnowledgeUnitRecord> KEY_KNOWLEDGE_UNIT_PRIMARY = UniqueKeys0.KEY_KNOWLEDGE_UNIT_PRIMARY;
    public static final UniqueKey<KnowledgeUnitRecord> KEY_KNOWLEDGE_UNIT_ID_UNIQUE = UniqueKeys0.KEY_KNOWLEDGE_UNIT_ID_UNIQUE;
    public static final UniqueKey<KnowHowUnitRecord> KEY_KNOW_HOW_UNIT_PRIMARY = UniqueKeys0.KEY_KNOW_HOW_UNIT_PRIMARY;
    public static final UniqueKey<KnowHowUnitRecord> KEY_KNOW_HOW_UNIT_ID_UNIQUE = UniqueKeys0.KEY_KNOW_HOW_UNIT_ID_UNIQUE;
    ...
    public static final UniqueKey<WorkUnitRecord> KEY_WORK_UNIT_PRIMARY = UniqueKeys0.KEY_WORK_UNIT_PRIMARY;
    public static final UniqueKey<WorkUnitRecord> KEY_WORK_UNIT_ID_UNIQUE = UniqueKeys0.KEY_WORK_UNIT_ID_UNIQUE;
    ...
    public static final ForeignKey<KnowledgeUnitRecord, KnowHowUnitRecord> FK_KNOWLEDGE_UNIT_KNOW_HOW_UNIT1 = ForeignKeys0.FK_KNOWLEDGE_UNIT_KNOW_HOW_UNIT1;
    public static final ForeignKey<KnowledgeUnitRecord, LectureRecord> FK_KNOWLEDGE_UNIT_LECTURE1 = ForeignKeys0.FK_KNOWLEDGE_UNIT_LECTURE1;
    ...
    public static final ForeignKey<WorkUnitRecord, KnowHowUnitRecord> FK_WORK_UNIT_KNOW_HOW_UNIT1 = ForeignKeys0.FK_WORK_UNIT_KNOW_HOW_UNIT1;
    public static final ForeignKey<WorkUnitRecord, TaskRecord> FK_WORK_UNIT_TASK1 = ForeignKeys0.FK_WORK_UNIT_TASK1;
    ...
    private static class Identities0 extends AbstractKeys {
        ...
        public static Identity<KnowledgeUnitRecord, Integer> IDENTITY_KNOWLEDGE_UNIT = createIdentity(KnowledgeUnit.KNOWLEDGE_UNIT, KnowledgeUnit.KNOWLEDGE_UNIT.ID);
        public static Identity<KnowHowUnitRecord, Integer> IDENTITY_KNOW_HOW_UNIT = createIdentity(KnowHowUnit.KNOW_HOW_UNIT, KnowHowUnit.KNOW_HOW_UNIT.ID);
        ...
        public static Identity<WorkUnitRecord, Integer> IDENTITY_WORK_UNIT = createIdentity(WorkUnit.WORK_UNIT, WorkUnit.WORK_UNIT.ID);
    }
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<KnowledgeUnitRecord> KEY_KNOWLEDGE_UNIT_PRIMARY = createUniqueKey(KnowledgeUnit.KNOWLEDGE_UNIT, "KEY_knowledge_unit_PRIMARY", KnowledgeUnit.KNOWLEDGE_UNIT.ID, KnowledgeUnit.KNOWLEDGE_UNIT.KNOW_HOW_UNIT_ID);
        public static final UniqueKey<KnowledgeUnitRecord> KEY_KNOWLEDGE_UNIT_ID_UNIQUE = createUniqueKey(KnowledgeUnit.KNOWLEDGE_UNIT, "KEY_knowledge_unit_id_UNIQUE", KnowledgeUnit.KNOWLEDGE_UNIT.ID);
        public static final UniqueKey<KnowHowUnitRecord> KEY_KNOW_HOW_UNIT_PRIMARY = createUniqueKey(KnowHowUnit.KNOW_HOW_UNIT, "KEY_know_how_unit_PRIMARY", KnowHowUnit.KNOW_HOW_UNIT.ID);
        public static final UniqueKey<KnowHowUnitRecord> KEY_KNOW_HOW_UNIT_ID_UNIQUE = createUniqueKey(KnowHowUnit.KNOW_HOW_UNIT, "KEY_know_how_unit_id_UNIQUE", KnowHowUnit.KNOW_HOW_UNIT.ID);
        ...
        public static final UniqueKey<WorkUnitRecord> KEY_WORK_UNIT_PRIMARY = createUniqueKey(WorkUnit.WORK_UNIT, "KEY_work_unit_PRIMARY", WorkUnit.WORK_UNIT.ID, WorkUnit.WORK_UNIT.KNOW_HOW_UNIT_ID);
        public static final UniqueKey<WorkUnitRecord> KEY_WORK_UNIT_ID_UNIQUE = createUniqueKey(WorkUnit.WORK_UNIT, "KEY_work_unit_id_UNIQUE", WorkUnit.WORK_UNIT.ID);
    }
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        ...
        public static final ForeignKey<KnowledgeUnitRecord, KnowHowUnitRecord> FK_KNOWLEDGE_UNIT_KNOW_HOW_UNIT1 = createForeignKey(lifetime.backend.persistence.jooq.Keys.KEY_KNOW_HOW_UNIT_PRIMARY, KnowledgeUnit.KNOWLEDGE_UNIT, "fk_knowledge_unit_know_how_unit1", KnowledgeUnit.KNOWLEDGE_UNIT.KNOW_HOW_UNIT_ID);
        public static final ForeignKey<KnowledgeUnitRecord, LectureRecord> FK_KNOWLEDGE_UNIT_LECTURE1 = createForeignKey(lifetime.backend.persistence.jooq.Keys.KEY_LECTURE_PRIMARY, KnowledgeUnit.KNOWLEDGE_UNIT, "fk_knowledge_unit_lecture1", KnowledgeUnit.KNOWLEDGE_UNIT.LECTURE_ID);
        ...
        public static final ForeignKey<WorkUnitRecord, KnowHowUnitRecord> FK_WORK_UNIT_KNOW_HOW_UNIT1 = createForeignKey(lifetime.backend.persistence.jooq.Keys.KEY_KNOW_HOW_UNIT_PRIMARY, WorkUnit.WORK_UNIT, "fk_work_unit_know_how_unit1", WorkUnit.WORK_UNIT.KNOW_HOW_UNIT_ID);
        public static final ForeignKey<WorkUnitRecord, TaskRecord> FK_WORK_UNIT_TASK1 = createForeignKey(lifetime.backend.persistence.jooq.Keys.KEY_TASK_PRIMARY, WorkUnit.WORK_UNIT, "fk_work_unit_task1", WorkUnit.WORK_UNIT.TASK_ID);
    }
}
