...
public class LifetimeEvent extends TableImpl<LifetimeEventRecord> {
    ...
    private static final long serialVersionUID = 1880233920;
     ...
     */
    public final TableField<LifetimeEventRecord, LifetimeEventStatus> STATUS = createField("status", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(lifetime.db.generated.jooq.enums.LifetimeEventStatus.class), this, "");
