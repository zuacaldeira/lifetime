 ...
 * @author lifetime
 */
public class LinguisticFormNew extends LinguisticFormEdit {

    public LinguisticFormNew(Linguistic l, LifetimeList<Linguistic> list) {
        super(l, list);
    }

    @Override
    protected void commitItem() {
        Linguistic linguistic = getItem();
