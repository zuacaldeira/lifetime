...
var __gwtModuleFunction = $wnd.lifetime_web_vaadin_MyAppWidgetset;
var $sendStats = __gwtModuleFunction.__sendStats;
$sendStats('moduleStartup', 'moduleEvalStart');
var $gwt_version = "7.4.1";
var $strongName = '';
var $gwt = {};
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.lifetime.web.vaadin.MyAppWidgetset=");
    idx += (13 + "lifetime.web.vaadin.MyAppWidgetset".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=lifetime.web.vaadin.MyAppWidgetset-0.js
